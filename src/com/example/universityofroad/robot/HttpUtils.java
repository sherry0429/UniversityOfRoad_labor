...
import com.example.universityofroad.robot.CommonException;
import com.example.universityofroad.robot.Result;
import com.google.gson.Gson;

public class HttpUtils
{
	private static String API_KEY = "167e278921bc3ba662315ddb326aca62";
	...
	public static ChatMessage sendMsg(String msg)
	{
		...
		{
			message.setMsg("未开发 未开发 未开发 嗞嗞嗞嗞嗞嗞...");
		}else
		{
